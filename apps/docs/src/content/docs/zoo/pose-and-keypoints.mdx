...
| [YOLO26 pose](https://huggingface.co/software-mansion/runntime-yolo26-pose) s | `models.keypointDetection.YOLO26_POSE.S` | COCO-17   | 640×640 (default) | f16, 20 MB |
| [YOLO26 pose](https://huggingface.co/software-mansion/runntime-yolo26-pose) m | `models.keypointDetection.YOLO26_POSE.M` | COCO-17   | 640×640 (default) | f16, 42 MB |
