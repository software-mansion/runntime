...
(5 MB, the `DEFAULT`), `S` (20 MB) and `M` (45 MB, more accurate, slower). Pass one as
...
| ------------------------------------------------------------------------------- | ------------------------------------------ | ------- | ----------------- | ---------- |
| [YOLO26 segment](https://huggingface.co/software-mansion/runntime-yolo26-seg) n | `models.instanceSegmentation.YOLO26_SEG.N` | COCO-80 | 640×640 (default) | f16, 5 MB  |
| [YOLO26 segment](https://huggingface.co/software-mansion/runntime-yolo26-seg) s | `models.instanceSegmentation.YOLO26_SEG.S` | COCO-80 | 640×640 (default) | f16, 20 MB |
| [YOLO26 segment](https://huggingface.co/software-mansion/runntime-yolo26-seg) m | `models.instanceSegmentation.YOLO26_SEG.M` | COCO-80 | 640×640 (default) | f16, 45 MB |
